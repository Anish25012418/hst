...
import {pokharaDayTrips} from "@/utils/constants/day-trips-constants.ts";
      ...
      {!isWindowDefined ? (
        ...
        <>
          <div className="relative">
            <Image
              src={"/image/pokharaDayTrips/pdt-1.jpeg"}
              alt="Banner"
              width={10}
              height={10}
          ...
          <div className="mx-[50px] md:mx-[105px] my-4 -translate-y-[100px]">
            ...
            <CustomTypography className="text-center text-xl">
              Pokhara is the perfect place to spend some time and chill out and there is no better way to explore the
              lake valley than by bicycle. Pokhara Day Trips cover a broead range of rider skills and fitness levels, we
              are sure you will find something that suits you.
            </CustomTypography>

            {pokharaDayTrips.map((trip, index) => (
...
export default PokharaDayTripsPage;